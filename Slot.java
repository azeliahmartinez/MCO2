...
public class Slot {
    ...
    /**
     * Constructs a new Slot object with the given slot number and slot capacity.
     *
     * @param slotNumber The unique identifier for the slot.
     * @param slotCapacity The maximum capacity of the slot, indicating the maximum number of items it can hold.
     */
