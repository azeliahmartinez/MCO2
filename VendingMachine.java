...
public class VendingMachine {
     ...
     *
     * @param vendingItems The list of items available in the vending machine represented as objects of the Item class.
     */
        ...
        if (featureType == 1) {
            ...
            switch (vendingMachineFeatures) {
                ...
                if (paymentFinished) {
                    ...
                    boolean selectItems = true;
                    List<Item> selectedItems = new ArrayList<>();
                    double totalPrice = 0;
                
                    // Create a CustomizedPackage object to hold the selected items
     ...
     *
     * @param numSlots The number of slots to set in the vending machine.
     */
     ...
     *
     * @return The list of slots in the vending machine, represented as objects of the Slot class.
     */
    ...
    */
    ...
    public void purchaseItem(int selectedSlot, double insertedAmount, double changeAmount) {
        ...
        // Update the quantity sold and total amount for the purchased item
        ...
        // Call the updateItemSales method to update the item's sales information in the slots
        updateItemSales(item.getItemName(), quantitySold, totalAmount);
    ...
    public void slotMenu() {
        ...
        switch (slotChoice) {
            case 1:
                // Action: Add item to a slot
                addItemToSlot();
                break;

            case 2:
                // Action: Edit item in a slot
                restockSlot();
                break;
    ...
    /**
     * Retrieves the list of names of items available in the vending machine.
     *
     * @return The list of names of items available in the vending machine.
     */
    ...
    /**
     * Retrieves the list of prices for each item in the vending machine.
     *
     * @return The list of prices for each item in the vending machine.
     */
    ...
    /**
     * Retrieves the list of amounts inserted by users into the vending machine.
     *
     * @return The list of amounts inserted by users into the vending machine.
     */
    ...
    /**
     * Retrieves the list of change amounts returned to users by the vending machine.
     *
     * @return The list of change amounts returned to users by the vending machine.
     */
